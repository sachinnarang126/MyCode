...
public class ApprovedAttendance {
    ...
    public class Result {
        ...
        public class AaDatum {
            ...
            @SerializedName("employeemanager_id")
            @Expose
             ...
             */
            public void setIspunchIn(Object ispunchIn) {
